    ...
    <section class=" py-8">
        <div class="container max-w-5xl mx-auto m-8">
            <h1 class="w-full my-2 text-3xl font-bold leading-tight text-center text-white ">
                🎉 Parabéns vocẽ encontrou a primeira flag na área do usuário coronel cascavel, continue explorando!🎉
            </h1>
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <p class="text-gray-600 mb-4">Sua tentativa de SQL Injection quebrou nossa consulta! Isso é um sinal de que você está no caminho certo, mas será que esse é realmente o admin?. Como recompensa, aqui está uma flag:</p>
